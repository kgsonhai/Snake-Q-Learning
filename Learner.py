        ...
        for i, h in enumerate(history[:-1]):
            if reason:  # Snake Died -> Negative reward
                ...
                self.qvalues[state_str][aN] = (1 - self.lr) * self.qvalues[state_str][
                    aN
                ] + self.lr * reward  # Bellman equation - there is no future state since game is over
                reason = None
            else:
                ...
                self.qvalues[state_str][a0] = (1 - self.lr) * (
    ...
    def _GetState(self, snake, food):
        ...
        for sq in sqs:
            if sq[0] < 0 or sq[1] < 0:  # off screen left or top
                ...
                sq[0] >= self.display_width or sq[1] >= self.display_height
